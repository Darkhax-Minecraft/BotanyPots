...
public class BotanyPotsJEIPlugin implements IModPlugin {
    ...
    public void registerRecipeCatalysts (IRecipeCatalystRegistration registration) {
        ...
        registration.addRecipeCatalyst(new ItemStack(BotanyPots.instance.getContent().basicBotanyPot), CategoryCrop.ID);
        registration.addRecipeCatalyst(new ItemStack(BotanyPots.instance.getContent().hopperBotanyPot), CategoryCrop.ID);
    }
    
    @Override
    public void registerRecipes (IRecipeRegistration registration) {
        
        final Collection<CropInfo> crops = BotanyPotHelper.getCropData(BotanyPotHelper.getManager()).values();
