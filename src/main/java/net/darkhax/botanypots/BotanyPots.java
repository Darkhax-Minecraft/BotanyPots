...
public class BotanyPots {
    ...
    public BotanyPots() {
        ...
        blockBotanyPot = this.registry.registerBlock(new BlockBotanyPot(), "botany_pot");
        tileBotanyPot = this.registry.registerTileEntity(TileEntityBotanyPot::new, "botany_pot", blockBotanyPot);
