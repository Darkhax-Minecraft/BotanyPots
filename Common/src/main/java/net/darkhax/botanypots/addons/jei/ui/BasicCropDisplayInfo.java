...
public class BasicCropDisplayInfo extends CropDisplayInfo {
    ...
    private IRecipeSlotTooltipCallback getSeedTooltip() {
        ...
        return (view, tooltip) -> {
            ...
            tooltip.add(new TranslatableComponent("tooltip.botanypots.grow_time", ticksToTime(this.growthTime)).withStyle(ChatFormatting.GRAY));
        };
    }
    ...
    private IRecipeSlotTooltipCallback getSoilTooltip() {
        ...
        return (view, tooltip) -> {
            ...
            tooltip.add(new TranslatableComponent("tooltip.botanypots.modifier", FORMAT.format(this.modifier)).withStyle(ChatFormatting.GRAY));
        };
    }
    ...
    private IRecipeSlotTooltipCallback getDropTooltip(HarvestEntry drops) {
        ...
        return (view, tooltip) -> {
            ...
            tooltip.add(new TranslatableComponent("tooltip.botanypots.chance", FORMAT.format(drops.getChance() * 100f)).withStyle(ChatFormatting.GRAY));
            ...
            if (rollMin == rollMax) {
                ...
                tooltip.add(new TranslatableComponent("tooltip.botanypots.rolls", rollMin).withStyle(ChatFormatting.GRAY));
            }

            else {

                tooltip.add(new TranslatableComponent("tooltip.botanypots.rollrange", rollMin, rollMax).withStyle(ChatFormatting.GRAY));
            }
        };
    }
