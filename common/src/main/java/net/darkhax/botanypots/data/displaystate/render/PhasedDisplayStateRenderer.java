...
public class PhasedDisplayStateRenderer<T extends PhasedDisplayState> extends DisplayStateRenderer<T> {
    ...
    @Override
    public void render(T displayState, PoseStack stack, Level level, BlockPos pos, MultiBufferSource bufferSource, int light, int overlay, float progress) {
        ...
        DisplayStateRenderer.renderState(currentState, stack, level, pos, bufferSource, light, overlay, progress);
    }
}