...
public interface ILookupInteractionListener {
     ...
     */
    @Nullable
    RecipeHolder<PotInteraction> lookup(BlockState state, Level level, BlockPos pos, Player player, InteractionHand hand, ItemStack heldStack, BlockEntityBotanyPot pot, RecipeHolder<PotInteraction> found);
}
