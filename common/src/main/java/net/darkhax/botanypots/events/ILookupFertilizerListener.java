...
@FunctionalInterface
public interface ILookupFertilizerListener {
     ...
     */
    @Nullable
    RecipeHolder<Fertilizer> lookup(BlockState state, Level level, BlockPos pos, Player player, InteractionHand hand, ItemStack heldStack, BlockEntityBotanyPot pot, RecipeHolder<Fertilizer> found);
}
